      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            <div key={index} className={`relative bg-white rounded-2xl shadow-soft border-2 transition-all duration-300 hover:shadow-strong slide-up ${plan.popular ? 'border-cta scale-105' : 'border-border'}`} style={{animationDelay: `${index * 200}ms`}}>
              {plan.popular && (
